...
export const EditAlbum = () => {
  ...
  const fetchDropdownOptions = async () => {
    ...
    try {
      const response = await fetch(
        "http://18.223.187.228:8081/GetAlbumns",
        requestOptions
      );
      if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://18.223.187.228:8081/UploadPhotoAlbum",
        formData,
        {
          headers: {
  ...
  const editAlbums = async () => {
    ...
    try {
      const response = await axios.post("http://18.223.187.228:8081/EditAlbums", {
        album: album,
        newName: newOption,
      });
      if (response.status === 200) {
  ...
  const deleteAlbums = async () => { 
    ...
    try {
      const response = await axios.post("http://18.223.187.228:8081/DeleteAlbums", {
        album: album,
